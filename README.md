# Hands-on sessions for the course on Deep Learning and Inverse Problems in Bremen
...
Select the GITHUB tab (1) and type `oterobaguer` (2). Then select the `bremen-dlip-course` (3) repository (master branch) and try the `00-simple-notebook` (4) to verify that it works.
